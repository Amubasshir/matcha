    ...
    <div className="px-4 sm:px-6 lg:px-8 ">
      ...
      <div className="mt-12 mb-16 border-t pt-8">
        <Tabs defaultValue="characteristics" className="w-full">
          <TabsList className="border-b w-full flex flex-wrap justify-start mb-4 overflow-x-auto">
            <TabsTrigger
              value="characteristics"
              className="text-base md:text-lg font-medium px-4 md:px-6 py-2 whitespace-nowrap data-[state=active]:text-green-700 data-[state=active]:border-b-2 data-[state=active]:border-green-700"
            >
              CHARACTERISTICS
            </TabsTrigger>
            <TabsTrigger
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <div>
                ...
                <p className="text-sm leading-relaxed text-gray-700">
                  ...
                  cherry juice*, white grape juice*, ginger juice* 3%, turmeric
                  juice* 3%, lemon juice*, fruit aroma juice concentrate*, white
                  pepper*
                  <br />
